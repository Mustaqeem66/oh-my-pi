...
const STOPWORDS: ReadonlySet<string> = new Set([
	"a", "an", "the", "to", "of", "and", "or", "for", "in", "on", "with", "that", "this",
	"from", "into", "as", "at", "by", "be", "is", "it", "we", "our", "add", "adds", "create",
	"creates", "build", "builds", "make", "makes", "new", "implement", "implements", "support",
	"supports", "use", "uses", "using", "want", "need", "should", "would", "please", "code",
]);
